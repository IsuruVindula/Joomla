...
(function ($) {
    $(document).ready(function () {
        $(".cwc-contact-tab.left").css("left", "0");
        $("#cwc-slideout.left").css("left", "-280px");
        $(".cwc-contact-tab.right").css("right", "0");
        $("#cwc-slideout.right").css("right", "-280px");
    });
    $(function () {
        $('.cwc-contact-tab.left').toggle(function () {
            $(this).parent().animate({"left": "0"}, 400); // Slide it out
