	...
	<div class="control-group">
		...
		<div class="controls">
			...
			<p class="help-block alert">
				...
				This will install Sample Data content to make it exactly as you see on the IceTheme Demo website. <br /> <span style="font-weight:bold"> Please make sure that "Default English (GB) Sample Data" option is selected</span>
			</p>
      <script type="text/javascript">
				radiobtn = document.getElementById("jform_sample_file1");
