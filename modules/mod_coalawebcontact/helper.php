...
JLoader::register('CoalaWebEmailHelper', JPATH_ADMINISTRATOR . $helppath . 'email.php');

/**
 * Class modCoalawebContactHelper
 */
class modCoalawebContactHelper extends JObject {

    /**
     * Unique ID for current module instance
     *
     * @var
     */
    private $uniqueid;
    ...
    /**
     * Mixed params from component and module
     * @var mixed
     */
    private $params;

    /**
     * modCoalawebContactHelper constructor.
     *
     * @param $uniqueId
     * @param $params
     * @param $comParams
    ...
    /**
     * Build params from both sources
     *
     * @param $params
     * @param $comParams
     * @return mixed
    ...
    public function getParams($params, $comParams) {
        ...
        $emailHelp = new CoalaWebEmailHelper();
    ...
    /**
     * Add assets needed for the functionality of the extension
     *
     */
